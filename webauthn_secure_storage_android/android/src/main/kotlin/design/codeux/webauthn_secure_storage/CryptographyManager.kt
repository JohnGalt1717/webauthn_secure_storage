// based on
// https://github.com/isaidamier/blogs.biometrics.cryptoBlog/blob/cryptoObject/app/src/main/java/com/example/android/biometricauth/CryptographyManager.kt
...
): CryptographyManagerImpl = CryptographyManagerImpl(configure)

@Suppress("ArrayInDataClass") data class EncryptedData(val encryptedPayload: ByteArray)

class CryptographyManagerImpl(private val configure: KeyGenParameterSpec.Builder.() -> Unit) :
        CryptographyManager {
    ...
    companion object {
        ...
        /**
         * Prefix for the key name, to distinguish it from previously written key. kind of
         * namespacing it.
         */
    ...
    override fun decryptData(ciphertext: ByteArray, cipher: Cipher): String {
        logger.debug {
            "decrypting ${ciphertext.size} bytes (iv: ${IV_SIZE_IN_BYTES}, tag: ${TAG_SIZE_IN_BYTES})"
        }
